...
function Navbar() {
  return (
    <>
      <div className="bg-stone-600 xsm:w-screen msm:w-screen xsm:h-[1000px] msm:h-[543px]">
        <ul className="flex msm:flex-row msm:gap-4 xsm:gap-2 gap-28 xsm:flex-col xsm:text-center msm:fixed  right-10  cursor-pointer text-opacity-85 z-50  top-0">
